...
#define paddleSizeY 70
#define paddleSizeX 10
#define paddleWallDistance 20
#define BallSize 10
...
int main()
{
    ...
    std::list<Border> borders = std::list<Border>();
    
    borders.push_back(Border(0,Border::Orientation::X));
    borders.push_back(Border(window.getSize().y,Border::Orientation::X));
     borders.push_back(Border(0,Border::Orientation::Y));
     borders.push_back(Border(window.getSize().x,Border::Orientation::Y));  
    ...
    while (window.isOpen())
    {
        ...
        for(std::list<Border>::iterator i = borders.begin(); i != borders.end(); ++i)
        {
