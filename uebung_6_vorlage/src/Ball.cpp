...
void Ball::catchEvent(EventType e) {
    if(e == EventType::PADDLE_ONE_BALL_COLLISION)
    {
        dir = sf::Vector2f(dir.y, -dir.x);
    }
    if(e == EventType::PADDLE_TWO_BALL_COLLISION)
    {
        dir = sf::Vector2f(dir.y, -dir.x);
    }
    if(e == EventType::BALL_X_BORDER_COLLISION)
    {
        dir = sf::Vector2f(dir.y, -dir.x);
    }
    if(e == EventType::BALL_Y_BORDER_COLLISION)
    {
